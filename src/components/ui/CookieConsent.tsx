...
export default function CookieConsent() {
  ...
  useEffect(() => {
    ...
    if (!consent) {
      Cookies.set("ux_consent", String(true), { expires: 365 });
      ...
      {show && (
        <motion.div
          ...
          style={{
            ...
            padding: "24px",
            boxShadow:
              "0 20px 40px rgba(0,0,0,0.4), 0 0 20px rgba(var(--accent-r), var(--accent-g), var(--accent-b), 0.1)",
            display: "flex",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 12, color: "#94a3b8", margin: "4px 0 0" }}>
                We use cookies to improve your experience and conduct UX
                research.
              </p>
            </div>
          </div>
